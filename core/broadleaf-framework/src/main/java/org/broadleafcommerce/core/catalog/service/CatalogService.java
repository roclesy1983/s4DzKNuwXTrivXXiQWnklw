...
public interface CatalogService {
	...
	/**
	 * Find a subset of {@code Product} instances whose name starts with or is
	 * equal to the passed in search parameter. Res
	 * 
	 * @param searchName
	 * @param limit
	 *            the maximum number of results
	 * @param offset
	 *            the starting point in the record set
	...
	/**
	 * Given a category and a ProudctSearchCriteria, returns the appropriate
	 * matching products
	 * 
	 * @param category
	...
	/**
	 * @deprecated Use
	 *             {@link #findFilteredActiveProductsByCategory(Category, SearchCriteria)}
	 * 
	 * @param category
	 * @param currentDate
	 * @param searchCriteria
	...
	/**
	 * Given a search query and a SearchCriteria, returns the appropriate
	 * matching products
	 * 
	 * @param query
	 * @param searchCriteria
	...
	/**
	 * Same as {@link #findActiveProductsByCategory(Category)} but allowing for
	 * pagination.
	 * 
	 * @param category
	 * @param limit
	...
	/**
	 * @deprecated Use {@link #findActiveProductsByCategory(Category, limit,
	 *             offset}
	 */
	@Deprecated
	 ...
	 *
	 * Automatic product bundles are collections of products that can receive
	 * special pricing. With automatic product bundles, if a customer adds all
	 * of the components of the bundle individually to the cart, they will
	 * automatically get assembeled into a bundle.
	 *
	 * @return
	 */
	...
	/**
	 * Retrieve a list of {@code Category} instances based on the search
	 * criteria
	 *
	 * @param categoryName
	 ...
	 * @param offset
	 *            the starting point of the records to return
	...
	/**
	 * Returns a category associated with the passed in URI or null if no
	 * Category is mapped to this URI.
	 * 
	 * @param uri
	 * @return
	 */
	...
	/**
	 * Returns a product associated with the passed in URI or null if no Product
	 * is mapped to this URI.
	 * 
	 * @param uri
	 * @return
	 */
	...
	/**
	 * Returns a list of
	 * {@link org.broadleafcommerce.core.catalog.domain.dto.AssignedProductOptionDTO}
